            ...
            <div class="container position-relative">
                <div class="row">
                    ...
                    <div class="col-12 col-md-10 d-flex flex-column gap-10">
                        <!-- 顯示載入中狀態 -->
                        <div v-if="!newsPending" class="text-center">
                            載入中...
                        </div>
                        <!-- 顯示錯誤訊息 -->
        ...
        >
            <div class="container">
                ...
                <div class="row flex-nowrap overflow-x-auto">
                    <!-- 顯示載入中狀態 -->
                    <div v-if="!culinaryStatus" class="text-center">
                        載入中...
                    </div>
                    <!-- 顯示錯誤訊息 -->
...
<script setup>
    ...
    const {
        ...
        status: newsPending,
        error: newsError,
    } = await useFetch("https://freyja-s8qg.onrender.com/api/v1/home/news/")
    const newsData = ref([])
    if (newsDataRaw) {
    ...
    // 獲取美食資料
    const {
        data: culinaryDataRaw,
        status: culinaryStatus,
        error: culinaryError,
    } = await useFetch("https://freyja-s8qg.onrender.com/api/v1/home/culinary/")
...
<style lang="scss" scoped>
    ...
    .room-intro .swiper {
        ...
        --percent-width: calc(
            var(--origin-width) / var(--container-width) * 100vw
        );
